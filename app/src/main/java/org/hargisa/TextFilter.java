...
public final class TextFilter extends DocumentFilter {
	...
	public void insertString(FilterBypass b, int offset,
                             String str, AttributeSet s) throws BadLocationException {

		// not allowed
	} // end of insertString method

	public void remove(FilterBypass b, int offset,
	...
	public void replace(FilterBypass b, int offset, int length,
                        String str, AttributeSet s) throws BadLocationException {
